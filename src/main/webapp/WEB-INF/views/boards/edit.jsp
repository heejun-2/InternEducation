...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/js/bootstrap.bundle.min.js" integrity="sha384-HwwvtgBNo3bZJJLYd8oVXjrBZt8cqVSpeBNS5n7C8IVInixGAoxmnlMuBnhbgrkm" crossorigin="anonymous"></script>
    ...
    <form:form class="container" action="/boards/update" modelAttribute="board" method="post" enctype="multipart/form-data">
        <div class="mb-4"></div>
        <input type="hidden" name="boardId" value="${board.boardId}">
        <div class="mb-4">
            <label for="exampleFormControlInput2" class="form-label">작성자</label>
            <input type="text" class="form-control" id="exampleFormControlInput2" name="name" value="${board.name}" readonly>
